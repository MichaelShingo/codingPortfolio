...
const Intro = () => {
	...
	return (
		<div
			...
			} transition duration-1000 scroll flex h-screen w-screen flex-col items-center justify-evenly space-y-10 overflow-x-hidden overflow-y-hidden absolute bg-paper-white z-50`}
		>
